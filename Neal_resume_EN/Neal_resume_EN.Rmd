...
tribble(
  ...
  "Data Scientist", "Apple, AppleCare", "Sunnyvale, CA", "01/2020 - Present", 
    list("In charge of contact center demand forecasting in the EMEIA market for 24 languages and more than 100 queue types.",
...
tribble(
    ~ category,
    "Skills: R, Python, SQL, Tableau, Advanced Excel, Snowflake, Claude Code",
    "Languages: Mandarin Chinese (native), English (with work proficiency)"
  ) %>%
